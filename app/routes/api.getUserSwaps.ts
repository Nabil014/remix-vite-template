...
const response = await fetch('https://omni.icarus.tools/polygon/cush/allSwapsForUser', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    params: [
      account,
      oneDayAgo.getTime(), // Start of the range
      currentDate.getTime() // End of the range
    ]
  })
});
