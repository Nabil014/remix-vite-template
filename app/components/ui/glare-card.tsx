...
export const GlareCard = ({
  ...
  const containerStyle = {
    ...
    "--foil-size": "100%",
    "--opacity": "0",
    "--radius": "12px", // Adjusted for button size
    "--easing": "ease",
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[100px] h-[40px] [aspect-ratio:2.5/1]" // Adjusted for button size
      ref={refElement}
      onPointerMove={(event) => {
