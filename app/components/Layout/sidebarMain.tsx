        ...
        <ul className='space-y-2  mt-8 font-medium'>
          <li>
            <Link
              ...
              className='flex items-center text-[#6EEAEA] p-2 gap-x-6 rounded-lg hover:bg-gray-100 hover:text-gray-900 group'
            >
              <svg
          ...
          <li>
            ...
            >
              ...
              <div>
                Whale Alerts
                <span className='inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full  dark:text-gray-300'>
                  Pro
                </span>
              </div>
            </Link>
